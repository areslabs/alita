...
export default class C extends Component {
    constructor(...args) {
        ...
        _defineProperty(this, "handleAni1", () => {
        ...
        _defineProperty(this, "handleAni2", () => {
            if (this.unfocus) return
            const ani = createAnimation({
                duration: 1500,
        ...
        _defineProperty(this, "handleLoading1", () => {
            if (this.unfocus) return
            const ani = createAnimation({
                duration: 800,
                timingFunction: "linear"
        ...
        _defineProperty(this, "handleLoading2", () => {
            if (this.unfocus) return
            const ani = createAnimation({
                duration: 150,
                timingFunction: "linear"
        ...
        _defineProperty(this, "handleAni7", () => {
            if (this.unfocus) return
            const ani = createAnimation({
                duration: 800,
                timingFunction: "ease"
        ...
        _defineProperty(this, "handleAni8", () => {
            if (this.unfocus) return
            const ani = createAnimation({
                duration: 800,
                timingFunction: "ease"
